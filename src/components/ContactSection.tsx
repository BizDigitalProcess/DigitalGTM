      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            <span className="gradient-text">Мои</span> контакты
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
          ...
          <Card className="tech-card flex flex-col h-full hover:-translate-y-1 transition-all duration-300">
            <CardContent className="p-6 flex flex-col h-full">
              ...
              <p className="text-foreground/70 mb-6 flex-grow">
                Для быстрого обсуждения вашего проекта, вопросов и предложений о сотрудничестве вы можете написать мне лично в Telegram.
              </p>
              <Button 
                className="btn-primary w-full"
