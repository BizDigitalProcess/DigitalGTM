    ...
    <footer className="bg-tech-dark-bg text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <Link to="/" className="font-bold text-2xl gradient-text">AI Vision</Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/contact" className="text-gray-300 hover:text-tech-purple transition-colors">Контакты</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">Email: hello@example.com</li>
              <li className="text-gray-300">Телефон: +7 (XXX) XXX-XX-XX</li>
              <li className="mt-4">
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-300 hover:text-tech-purple transition-colors">
                    TG
                  </a>
                  <a href="#" className="text-gray-300 hover:text-tech-purple transition-colors">
                    VK
        ...
        <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} AI Vision. Все права защищены.
          </p>
