  ...
  return (
    <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Small title moved to top corner */}
        <div className="mb-8 text-left absolute top-0 left-8">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:space-x-16">
          ...
          {/* Right side - Background image instead of infographic */}
          <div className="w-full lg:w-1/2 relative h-64 lg:h-80">
            <div className="absolute inset-0 bg-[url('/lovable-uploads/03a35695-ef86-4301-b561-62513f166123.png')] bg-cover bg-center rounded-lg opacity-20"></div>
            <div className="absolute inset-0 bg-gradient-to-tr from-tech-purple/30 to-tech-orange/30 rounded-lg"></div>
