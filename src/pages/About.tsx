          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-lg dark:prose-invert">
                ...
                <p>
                  Я, Богомолов Глеб, убежден, что успешная автоматизация начинается с глубокого понимания бизнес-процессов. Поэтому каждый проект я начинаю с тщательного анализа текущей ситуации, выявления узких мест и определения ключевых показателей эффективности.
                </p>
